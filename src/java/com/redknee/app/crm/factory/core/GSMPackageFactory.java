 ...
 * @since 
 */
public class GSMPackageFactory extends CoreBeanAdaptingContextFactory<com.redknee.app.crm.bean.GSMPackage, GSMPackage>
{   
    public GSMPackageFactory(ContextFactory delegate)
    {
        super(com.redknee.app.crm.bean.GSMPackage.class, 
                GSMPackage.class, 
                delegate);
    }
    ...
    {
        final GSMPackage pkg = (GSMPackage)super.create(ctx);
