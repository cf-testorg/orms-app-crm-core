 ...
 * @since 9.5.0
 */
public abstract class ProvinceMapperCacheUpdateHome extends HomeProxy
{
     ...
     */
    public ProvinceMapperCacheUpdateHome(Context ctx, final Home delegate) throws HomeException
    {
        super(delegate);
    }
    ...
    abstract AbstractPrefixToProvinceMapper getProvinceMapper(Context ctx);
    ...
    {
        AbstractPrefixToProvinceMapper mapper = getProvinceMapper(ctx);
        mapper.validate(ctx);
    }
}
