...
/**
 * Prepares and installs the CRMEmailTemplateHome into the application context.
 * 
 * @author abaid
 * 
 */
public class EmailTemplateHomePipelineFactory implements PipelineFactory
{
    ...
    {
        Home emailTemplateHome = CoreSupport.bindHome(ctx, CRMEmailTemplate.class);
        emailTemplateHome = new AuditJournalHome(ctx, emailTemplateHome);
        emailTemplateHome = new RMIClusteredHome(ctx, CRMEmailTemplate.class.getName() + StorageInstall.CORE_CLUSTER_SUFFIX, emailTemplateHome);
        emailTemplateHome = new SortingHome(emailTemplateHome);
        emailTemplateHome = new SpidAwareHome(ctx, emailTemplateHome);
        return emailTemplateHome;
    }
}
