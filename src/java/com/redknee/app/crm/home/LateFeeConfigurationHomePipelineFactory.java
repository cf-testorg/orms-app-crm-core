 ...
 * @since 8.4
 */
public class LateFeeConfigurationHomePipelineFactory implements PipelineFactory
{
    /**
     * {@inheritDoc}
     */
            ...
            throws HomeException
    {
        Home home = StorageSupportHelper.get(context).createHome(context,
                LateFeeConfiguration.class, "LateFeeConfiguration");
        ...
        home = new IdentifierSettingHome(context, home,
                IdentifierEnum.LATE_FEE_CONFIGURATION_ID, null);

        IdentifierSequenceSupportHelper.get(context).ensureNextIdIsLargeEnough(context,
                IdentifierEnum.LATE_FEE_CONFIGURATION_ID, home);
