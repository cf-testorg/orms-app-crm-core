 ...
 * @since 
 */
public class CoreVSATPackageHomePipelineFactory implements PipelineFactory
{
    ...
    {
        // TDMA Package Home
        Home home = StorageSupportHelper.get(ctx).createHome(ctx, VSATPackage.class, "VSATPACKAGE");
        ...
        home = new AdapterHome(
                ctx, 
                home, 
                new ExtendedBeanAdapter<com.redknee.app.crm.bean.VSATPackage, com.redknee.app.crm.bean.core.VSATPackage>(
