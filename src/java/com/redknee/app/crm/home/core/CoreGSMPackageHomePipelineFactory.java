 ...
 * @since 
 */
public class CoreGSMPackageHomePipelineFactory implements PipelineFactory
{
    ...
    {
        // GSM Package Home
        Home home = StorageSupportHelper.get(ctx).createHome(ctx, GSMPackage.class, "SIMCARD");
        ...
        home = new AdapterHome(
                ctx, 
                home, 
                new ExtendedBeanAdapter<com.redknee.app.crm.bean.GSMPackage, com.redknee.app.crm.bean.core.GSMPackage>(
