 ...
 * @since 8.8/9.0
 */
public class SimpleUjacMessageGenerator extends AbstractSimpleUjacMessageGenerator
{
    ...
    {
        throw new MessageGenerationException("UJAC message generation is not yet supported.");
    }
