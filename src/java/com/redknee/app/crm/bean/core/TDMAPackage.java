 ...
 * @since
 */
public class TDMAPackage extends com.redknee.app.crm.bean.TDMAPackage implements GenericPackage
{
    ...
    public String getDefaultResourceID(Context ctx) throws HomeException
    {
        ...
        ResourceDeviceDefaultPackage association = HomeSupportHelper.get(ctx).findBean(ctx, ResourceDeviceDefaultPackage.class,
    ...
    public Object delegatePackageProcessing(final Context context, final PackageProcessor processor)
