 ...
 * @since 8.2
 */
public interface SubscriptionTypeAware
{
    ...
    /**
     * Returns the SubscriptionType bean for this object.
     * 
     * @param ctx IN The operating context.
     * @return The SubscriptionType if one exists for the set identifier; null otherwise.
     */
    public com.redknee.app.crm.bean.core.SubscriptionType getSubscriptionType(Context ctx);
}
