...
import com.redknee.app.crm.bean.LateFeeConfigurationWebControl;
 ...
 * @since 8.4
 */
public class CustomLateFeeConfigurationWebControl extends LateFeeConfigurationWebControl
{
    @Override
    ...
    public static final WebControl CUSTOM_ADJUSTMENT_TYPE_WC = new AdjustmentTypeCategoryProxyWebControl(
            new AdjustmentTypeKeyWebControl(), AdjustmentTypeEnum.LateFee);
