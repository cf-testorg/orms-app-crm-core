 ...
 * @since 8.2
 */
public class StructureChildValueCalculator extends AbstractStructureChildValueCalculator
{
    public StructureChildValueCalculator()
    {
    }

    
    public StructureChildValueCalculator(ValueCalculator delegate)
    {
    ...
    public void addProxy(StructureChildValueCalculator proxy)
    {
    ...
    public void appendProxy(StructureChildValueCalculator proxy)
    {
    	if(getDelegate() == null) return ;
        if ( getDelegate() instanceof StructureChildValueCalculator )
        {
            StructureChildValueCalculator delegate = (StructureChildValueCalculator) getDelegate();
    ...
    public ValueCalculator findDecorator(Class cls)
    {
        ...
        if ( delegate instanceof StructureChildValueCalculator )
        {
            return ((StructureChildValueCalculator) delegate).findDecorator(cls);  
        }
