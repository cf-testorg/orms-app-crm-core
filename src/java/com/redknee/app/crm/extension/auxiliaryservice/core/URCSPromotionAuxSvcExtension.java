...
/**
 * Implements the URCS Promotion auxiliary service extension.
 * @author Marcio Marques
 * @since 9.1.2
 *
 */
public class URCSPromotionAuxSvcExtension extends com.redknee.app.crm.extension.auxiliaryservice.URCSPromotionAuxSvcExtension implements FinalExtension,
MandatoryExtension, TypeDependentExtension
{
    ...
    {
        return AuxiliaryServiceTypeEnum.URCS_Promotion.equals(auxiliaryServiceType);
    }

    public static URCSPromotionAuxSvcExtension getURCSPromotionAuxSvcExtension(Context ctx, long auxiliaryServiceID) throws HomeException
    {
        Home home = (Home) ctx.get(URCSPromotionAuxSvcExtensionHome.class);
        return (URCSPromotionAuxSvcExtension) home.find(ctx, new EQ(URCSPromotionAuxSvcExtensionXInfo.AUXILIARY_SERVICE_ID, auxiliaryServiceID));
    }
}
