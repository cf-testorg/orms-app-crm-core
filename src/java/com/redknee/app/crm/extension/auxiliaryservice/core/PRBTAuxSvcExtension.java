...
import com.redknee.app.crm.extension.auxiliaryservice.PRBTAuxSvcExtensionXInfo;
...
/**
 * Implements the PRBT auxiliary service extension.
 * @author Marcio Marques
 * @since 9.1.2
 *
 */
public class PRBTAuxSvcExtension extends com.redknee.app.crm.extension.auxiliaryservice.PRBTAuxSvcExtension implements MandatoryExtension, TypeDependentExtension
{
    @Override
    ...
    {
        return AuxiliaryServiceTypeEnum.PRBT.equals(auxiliaryServiceType);
    }

    public static PRBTAuxSvcExtension getPRBTAuxSvcExtension(Context ctx, long auxiliaryServiceID) throws HomeException
    {
        Home home = (Home) ctx.get(PRBTAuxSvcExtensionHome.class);
        return (PRBTAuxSvcExtension) home.find(ctx, new EQ(PRBTAuxSvcExtensionXInfo.AUXILIARY_SERVICE_ID, auxiliaryServiceID));
    }
}
